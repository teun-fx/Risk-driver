  ...
  return (
    <div style={{ padding: '36px 40px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: 400 }}>
      <div style={{ background: t.card, borderRadius: 20, padding: '40px 48px', maxWidth: 520, width: '100%' }}>
        <div style={{ width: 44, height: 44, borderRadius: 12, background: t.brand, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 22, marginBottom: 20 }}>✦</div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          {options.map(s => (
            ...
            >
              <div style={{ width: 36, height: 36, borderRadius: 10, background: 'rgba(161,213,51,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 16, flexShrink: 0 }}>📊</div>
              <div>
  ...
  return (
    <div style={{ padding: '36px 40px', display: 'flex', flexDirection: 'column', height: '100%', boxSizing: 'border-box' }}>
      <div style={{ marginBottom: 24, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div>
          <h1 style={{ fontSize: 26, fontWeight: 600, color: t.text, letterSpacing: '-0.5px', margin: 0, marginBottom: 4 }}>AI Advisor</h1>
            ...
            <div key={i} style={{ display: 'flex', justifyContent: msg.role === 'user' ? 'flex-end' : 'flex-start', marginBottom: 16 }}>
              {msg.role === 'assistant' && (
                <div style={{
                  ...
                  fontSize: 14, marginRight: 10, flexShrink: 0, color: '#000',
                }}>✦</div>
              )}
              <div style={{
                maxWidth: '75%',
