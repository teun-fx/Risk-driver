  ...
  switch (id) {
    ...
    case 'costs':
      return (
        <svg {...props}>
          ...
          <path d="M12 7v10M9.5 9.5C9.5 8.1 10.6 7 12 7c1.4 0 2.5 1 2.5 2.2 0 1.3-1.1 2-2.5 2s-2.5.8-2.5 2.3c0 1.3 1.1 2.5 2.5 2.5s2.5-1 2.5-2.5" />
        </svg>
      );
    case 'roadmap':
      return (
        <svg {...props}>
          <path d="M3 17l4-8 4 4 4-6 4 2" />
    ...
    case 'insights':
      return (
        <svg {...props}>
          <path d="M9 21h6" />
          <path d="M12 3a6 6 0 016 6c0 2.2-1.2 4.2-3 5.4V17H9v-2.6A6 6 0 0112 3z" />
        </svg>
      );
    default: return null;
  }
          ...
          return (
            <button
              ...
              style={{
                ...
                background: isActive ? 'rgba(161,213,51,0.08)' : 'transparent',
                color: isActive ? t.brand : t.navText,
      ...
      <div style={{ padding: '16px 20px', borderTop: `1px solid ${t.sidebarBorder}` }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <div style={{
            ...
            background: 'rgba(161,213,51,0.15)',
            border: `1px solid rgba(161,213,51,0.25)`,
            display: 'flex', alignItems: 'center', justifyContent: 'center',
